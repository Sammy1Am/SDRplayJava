 ...
 * @author Sammy1Am
 */
public abstract class StreamsReceiver {
    void receiveStreamA(short[] xi, short[] xq, StreamCbParamsT params, int numSamples, int reset){};
    void receiveStreamB(short[] xi, short[] xq, StreamCbParamsT params, int numSamples, int reset){};
    void receiveEvent(EventT eventId, TunerSelectT tuner, EventParamsT params){};
